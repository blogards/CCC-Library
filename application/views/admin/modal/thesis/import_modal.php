                    ...
                    <div id="PrimaryModalalertedit" class="modal modal-edu-general default-popup-PrimaryModal fade" role="dialog">
                      <div class="modal-dialog">
                        <div class="modal-content">
                          ...
                          <form id="update_form" method="post" name="userform" enctype="multipart/form-data" action="<?=site_url('library_resources/importThesis');?>">
                          <div class="modal-body">
                            ...
                            <div class="modal-footer">
                                ...
                                <input class="Primary mg-b-10 btn btn-custon-rounded-two btn-success" type="submit" href="#" name="import_thesis_btn" value="Proceed" >
                            </div>
                          </div>
                          </form>
                        </div>
