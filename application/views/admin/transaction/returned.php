    ...
    <div class="data-table-area mg-b-15">
                                ...
                                <div class="sparkline13-hd">
                                    <div class="main-sparkline13-hd">
                                        <div class="col-lg-11 col-md-10 col-sm-11 col-xs-12">
                                            <h1>Library Resources / Returned</h1>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="false" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true"
                                            ...
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th data-field="borrowed">Borrowed Date</th>
                                                    <th data-field="due">Expected Return Date</th>
                                                    <th data-field="return">Returned Date</th>
                                                    <!-- <th data-field=""></th> -->
                                            ...
                                            <?php $num = 1;
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?=date("M d, Y", strtotime($resource->due_date))?> </td>
                                                    <td><?=date("M d, Y", strtotime($resource->returned_date))?> </td>
                                                      
                                                    <!-- <td>
                                                      <div style="display: flex;">
                                                        <a class="media" href="" style="background: #1aff00"><i class="fa fa-eye" aria-hidden="true"></i></a>
                                                        <button class="btn " data-toggle="modal" data-target="#resource<?=$resource->lib_id?>" style="background: #1aff00">Receive</button>
                                                      </div>
                                                    </td> -->
                                                </tr>
                                                <?php endforeach ?>
            ...
            <?php $this->load->view('admin/modal/transaction/return_reservation_modal.php');?>