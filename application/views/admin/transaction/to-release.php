                            ...
                            <div class="sparkline13-hd">
                                <div class="main-sparkline13-hd">
                                    <div class="col-lg-11 col-md-10 col-sm-11 col-xs-12">
                                        <h1>Resources Reservation / To Release</h1>
                                    </div>
                                    ...
                                    <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="false" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true"
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th data-field="pickup">Expected Pickup Date</th>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                  <div style="display: flex;">
                                                    ...
                                                    <button class="btn " data-toggle="modal" data-target="#resource<?=$resource->lib_id?>" style="background: #1aff00">Release</button>
                                                  </div>
                                                </td>
                                            </tr>
                                            <?php endforeach ?>
        ...
        <!-- Static Table End --> 
        <!-- <?php $this->load->view('admin/modal/transaction/release_reservation_modal.php');?> -->