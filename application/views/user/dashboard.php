<div class="analytics-sparkle-area">
                                    ...
                                    <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="false" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true"
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <?php if($process->due_date == NULL ){ 
                                                    echo '<td></td>';
                                                }else{
                                                    echo '<td>'.date("M d, Y", strtotime($process->due_date)).'</td>';
                                                }
                                                ?>
                                                ...
                                                <td>
                                                    <div style="display: flex;">
                                                        ...
                                                        <button class="btn " data-toggle="modal" data-target="#resource<?=$process->lib_id?>" 
                                                        <?php if($process->status != 'Reserved'){ echo 'disabled'; } ?>
                                                        style="background: #1aff00">Cancel</button>
                                                    </div>
                                                </td>
                                            </tr>
                                            <?php endforeach ?>
                                    ...
                                    <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="false" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true"
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th data-field="reservation_date">Reservation Date</th>
                                                <th data-field="due_date">Due Date</th>
                                                <th data-field="return">Date Returned</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            ...
                                            <?php foreach($has_returned as $returned): ?>
                                                ...
                                                <td><?=date("M d, Y", strtotime($returned->returned_date))?></td>
                                                <!-- <td>
                                                  <div style="display: flex;">
                                                    <a class="media" href="" style="background: #1aff00"><i class="fa fa-eye" aria-hidden="true"></i></a>
                                                  </div>
        ...
        <?php $this->load->view('user/modal/cancel_reservation_modal.php');?>
