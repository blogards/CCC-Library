                            ...
                            <div class="sparkline13-hd">
                                <div class="main-sparkline13-hd">
                                    <div class="col-lg-11 col-md-10 col-sm-11 col-xs-12">
                                        <h1>Available Library Resources / Books</h1>
                                    </div>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                  ...
                                                  <div style="display: flex;">
                                                    ...
                                                    <!-- <a title="More information" class="media" style="background: #1aff00"><i class="fa fa-info-circle" aria-hidden="true"></i></a> -->
                                                    <?php  if($this->session->userdata('user_type') == 'Admin' || $this->session->userdata('user_type') == 'Library Staff'){?>
                                                  
                                                  
                                                  <?php }else{?>
                                                    <a class="media" name="view_pdf"  style="background: #1aff00"><i class="fa fa-eye view_pdf" file="<?=site_url('tools/files/').$resource->soft_copy?>"  aria-hidden="true"></i>
                                                  </a>
